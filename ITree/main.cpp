...
void TreeVision( pcl::visualization::PCLVisualizer::Ptr viewer, ProcessPointClouds<pcl::PointXYZ>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZ>::Ptr inputCloud)
{
...
//    color = {0, 0, 255};
//    colorize((*segmentCloud.second).points, *src_colored, color);
...
//        renderPointCloud(viewer,inputCloudI,"inputCloudI");
        TreeVision(viewer, pointProcessorI, inputCloudI);
