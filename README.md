...
If you do not explicitly declare an x64 build, vcpkg will default it to x86 and cmake will probably fail. Remember that Microsoft works hard to make their products unusable.
