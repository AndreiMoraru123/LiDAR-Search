//
// Created by Andrei on 03-Oct-22.
//
...
struct Ray
{
    ...
    /// @param verticalAngle: the angle of direction between xy plane and ray
    /// 				  for example 0 radians is along xy plane and pi/2 radians is straight up
    /// @param setResolution: the magnitude of the ray's step, used for ray casting, the smaller the more accurate but the more expensive
